<template>
        ...
        <transition>
            <div v-if="show" @click.self="show = false" class="inset-0 fixed bg-gray-300/80 flex justify-center items-center z-10">
                <form action="" method="POST" @submit.prevent="submit" class="z-20 bg-white p-6 rounded">
                    <div class="mb-3">
                        ...
                        <input
                            type="text"
                            v-model="form.name"
                            class="border rounded p-2 border-teal-300 bg-teal-100"
                            placeholder="Name"
                        />
